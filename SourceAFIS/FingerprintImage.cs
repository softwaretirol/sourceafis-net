...
/// <remarks>
///     <para>
///         This class captures all fingerprint information that is available prior to construction of
///         <see cref="FingerprintTemplate" />.
...
public class FingerprintImage
{
    ...
    ///         SourceAFIS will try to decode the image using
    ///         <a href="https://sixlabors.com/products/imagesharp/">ImageSharp</a> library.
            ...
            using (var decoded = SKBitmap.Decode(image))
            {
                ...
                for (var y = 0; y < Matrix.Height; ++y)
                {
                    for (var x = 0; x < Matrix.Width; ++x)
                    {
                        ...
                        double color = pixel.Red + pixel.Green + pixel.Blue;
